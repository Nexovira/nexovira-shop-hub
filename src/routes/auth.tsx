...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [
      { title: "Sign in — NEXOVIRA" },
      { name: "description", content: "Sign in or create your NEXOVIRA account." },
      ...
      <div className="w-full max-w-md">
        <Link to="/" className="flex items-center justify-center gap-2 mb-8 text-white">
          ...
          <div className="leading-tight">
            <div className="text-lg font-bold tracking-tight">NEXOVIRA</div>
            <div className="text-[10px] uppercase tracking-widest text-white/70">Global Ventures</div>
          </div>
        </Link>

        <Card className="p-6 shadow-lifted">
